...
class UserFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $userClient->setPassword($this->encoder->encodePassword($userClient, 'notaresto'));
        ...
        $userRestaurateur->setPassword($this->encoder->encodePassword($userRestaurateur, 'notaresto'));
